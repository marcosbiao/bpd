        ...
        <div class="container panel panel-default">
				...
				<div class="panel panel-default jumbotron">	
					<div id="vpav"></div>
	  					...
	  					<input type="text" required="required" class="form-control" id = "nomeCurso" name="nomeCurso" placeholder="Digite o nome do curso" aria-describedby="sizing-addon2">
					
                                        </div>
                                        
                                        <div class="input-group">
	  					<span class="input-group-addon" id="sizing-addon2">Supervisor de estagio</span>
	  					<input type="text" required="required" class="form-control" id = "nomeSupervisor" name="nomeSupervisor" placeholder="Digite o seu nome da instituição" aria-describedby="sizing-addon2">
                                        </div>
                                        Dados do estagio:
                                        <div class="input-group">
	  					<span class="input-group-addon" id="sizing-addon2">Periodo de virgencia</span>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="cargaHoraria" name="cargaHoraria" required="required">
                                            ...
                                            <input type="text" required="required" pattern="[0-9]+$" class="form-control" id = "valorAuxilioTrasporte" name="valorAuxilioTrasporte" aria-describedby="sizing-addon2">
                                        
                                        </div>
                                        
                                        <div class="input-group">
	  					<span class="input-group-addon" id="sizing-addon2">Local do estagio</span>
	  					<input type="text" required="required" class="form-control" id = "localEstagio" name="localEstagio" aria-describedby="sizing-addon2">
                                        </div>
