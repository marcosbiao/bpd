...
<?php 
    ...
    $query = "SELECT d.idDiaria, pr.nome,p.nome, d.autorizado FROM diaria d join programa pr on d.programa_idPrograma = pr.idPrograma join pessoa p on d.pessoa_cpf = p.cpf where d.autorizado=0 ";
    $rs = Select ($query);
